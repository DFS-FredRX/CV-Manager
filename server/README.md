...
* **Framework :** NestJS v11.1.13 (Progressive Node.js framework).
* **Langage :** TypeScript v5.9.3 pour un typage statique fort.
* **Base de données :** MySQL via l'ORM TypeORM v0.3.28.
* **Sécurité :** Hachage via Argon2 v0.44 et authentification JWT avec Passport.
* **Tests :** Jest v30.2 pour les tests unitaires et E2E.
...
* **Emails :** Intégration de nodemailer pour les procédures d'activation et de récupération.
